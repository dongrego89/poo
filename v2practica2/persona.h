...
public:
	Persona(string d,string n="",string a="",string di="",string l="",string pr="",string p=""){DNI_=d;nombre_=n;apellidos_=a;direccion_=di;localidad_=l;provincia_=pr;pais_=p;}	
